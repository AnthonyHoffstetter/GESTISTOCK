...
import { StockOutService, StockOutEntry } from '../../services/stock-out.service';
...
export class StockOutPage implements OnInit {
  ...
  loadEntries(): void {
    ...
    this.stockOutService.getStockOuts().subscribe({
      ...
      error: (_err: HttpErrorResponse) => {
        this.error.set('Impossible de charger les sorties de stock.');
        this.loading.set(false);
      }
    });
  }
  ...
  get filteredEntries(): StockOutEntry[] {
